...
public class ApiClient {
    ...
    private String basePath = "https://se-exchange-uat-sandbox.apigee.net/openesx/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://se-exchange-uat-sandbox.apigee.net/openesx/v1
